...
class ComebotEnv(gym.Env):      #gym.Env 상속
    ...
    def __init__(self,cv_send,cv_recv,mode=None,recv_packet=None):
    ...
    def step(self, action):
        ...
        if self.recv_packet[0] == "ID:":
            ...
            Tired_Para      = self.recv_packet[2]
            Touch_Sensor    = self.recv_packet[3]
            Force_Sensor    = self.recv_packet[4]
            Lift_Sensor     = self.recv_packet[5]
            Oled_State      = self.recv_packet[6]
            Fin_State       = self.recv_packet[7]
            Tail_State      = self.recv_packet[8]
