...
def build_callbacks(env_name):
    ...
    callbacks = [ModelIntervalCheckpoint(checkpoint_weights_filename, interval=20)]
...
def ReinForceThread(cv_send, cv_recv):
    ...
    while True:
        ...
        dqn = DQNAgent(model=model, nb_actions=num_actions,
                       memory=memory, nb_steps_warmup=20,
