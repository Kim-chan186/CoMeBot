...
# from Scripts.ReinforcePython import Hungry_Para
# import Scripts.ReinforcePython.Hungry_Para
...
def reinforce(cv_send,cv_recv,recv_packet,mode):
    # cv_recv.acquire()
    # cv_recv.wait()
    # cv_recv.release()
    ...
    env = ComebotEnv(cv_send,cv_recv,recv_packet,mode)  # 코미봇환경 불러오기
