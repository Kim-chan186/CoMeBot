    ...
    def step(self, action):
        ...
        if recv_packet[0] == "ID:":
            ...
            if step_cnt < 100:
                ...
                self.Touch_Sensor = random.randrange(1, 5)
...
def ReinForceThread(cv_send, cv_recv):
    ...
    while True:
        ...
        policy = LinearAnnealedPolicy(EpsGreedyQPolicy(), attr='eps',
                                      value_max=1., value_min=.2, value_test=.1,
                                      nb_steps=2000)
        ...
        #dqn.compile(Adam(lr=0.1), metrics=['mse'])
        ...
        hist = dqn.fit(env, nb_steps=2000,
                       visualize=False,
                       verbose=2,
                       callbacks=callbacks)
